...
```
<img src="/assets/images/apm/1.png" width="80%">
...
<img src="/assets/images/apm/2.png" width="80%">
...
MySQL 버전 확인<br>
<img src="/assets/images/apm/6.png" width="60%">
...
```
workbench 접속화면<br>
<img src="/assets/images/apm/7.png" width="80%">
...
```
[PHP 화면 출력]
<img src="/assets/images/apm/8.png" width="80%">
...
### FastCGI
FastCGI란 웹 서버의 응용 프로그램 언어인 공용 게이트웨이 인터페이스(CGI)에서 하나의 프로세스가 다중 CGI 요청을 처리하도록 하여 속도를 향상시킨 웹 서버 플러그인 프로그램. CGI에서는 매 요청 시마다 서비스를 제어하고 수행하는 프로세스를 새롭게 열고 닫아야 하지만, Fast CGI는 미리 만들어 놓은 프로세스와 데이터를 주고받음으로써 효율적이고 빠르게 작동합니다.
...
<img src="/assets/images/apm/9.png" width="80%">

이후 관리도구에서 CGI 추가 후 완료 합니다.

기본 Web Server 구축 이후 웹페이지 접속<br>
<img src="/assets/images/apm/10.png" width="80%">

---

### 2.PHP(FastCGI)
[PHP 설치] [PHP Download](https://windows.php.net/download/){: target="_blank"}<br>
<img src="/assets/images/apm/11.png" width="80%">

PHP는 다운로드 후 압축을 풀어줍니다.<br>
<img src="/assets/images/apm/12.png" width="80%">

[Windows > 관리도구 > IIS Manager 접속]<br>
<img src="/assets/images/apm/13.png" width="80%">

[Handler Mappings (처리기 맵핑) 클릭]<br>
<img src="/assets/images/apm/14.png" width="80%">

[모듈 맵핑 추가 > 해당 맵핑 추가 후 OK 클릭]<br>
<img src="/assets/images/apm/15.png" width="80%">

[FastCGI를 설정할지 여부 Yes 클릭]<br>
<img src="/assets/images/apm/16.png" width="80%">

[맵핑 확인]<br>
<img src="/assets/images/apm/17.png" width="80%">

[C:\inetpub\wwwroot\info.php 파일 생성]<br>
<img src="/assets/images/apm/18.png" width="80%">

PHP(FastCGI) 설정 완료 후 localhost/info.php로 접속을 해보면 아래와 같은 500번 에러 메시지가 발생 할 수 있습니다.<br>
<img src="/assets/images/apm/19.png" width="80%">

위와 같은 문제는 x64 기반의 OS에서 호환 문제로 인해 FastCGI 에러가 발생합니다.
Microsoft에서 이러한 경우를 위해 필요한 dll 파일들만 배포하여 Visual C++을 다운받아 설치하면 해결이 됩니다.<br>
[Visual C++ 설치] [Visual C++ Download](https://www.microsoft.com/en-us/download/confirmation.aspx?id=48145){: target="_blank"}<br>

Micrsoft Visual C++을 설치 이후 info.php 접속을 하면 아래와 같은 PHP 출력화면을 확인 할 수 있습니다.
또한 Server API를 확인해보면 FastCGI로 되어 있는 것을 확인 할 수 있습니다.
<img src="/assets/images/apm/20.png" width="80%">
